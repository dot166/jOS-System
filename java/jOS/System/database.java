...
public class database extends ContentProvider {
    ...
    public Cursor query(Uri uri, String[] projection, String selection,
        ...
        if (!Objects.equals(currentTheme, PreferenceManager.getDefaultSharedPreferences(getContext()).getString(KEY_THEME, "default"))) {
            ...
            for (int i = getContext().getResources().getStringArray(jOS.Core.R.array.themesConfig).length - 1; i >= 0; i--) {
                String themeName = (String) Array.get(getContext().getResources().getStringArray(jOS.Core.R.array.themesConfig), i);//screen.getPreference(i);
                Log.i("Database Update", themeName);
                SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(getContext());
                String themeNamePrefs = prefs.getString(KEY_THEME, "default");
                currentValue = themeName.equals(themeNamePrefs);
    ...
    private static class DatabaseHelper extends SQLiteOpenHelper {
        ...
        public void onCreate(SQLiteDatabase db) {
            ...
            for (int i = mContext.getResources().getStringArray(jOS.Core.R.array.themesConfig).length - 1; i >= 0; i--) {
                String themeName = (String) Array.get(mContext.getResources().getStringArray(jOS.Core.R.array.themesConfig), i);//screen.getPreference(i);
                Log.i("Database init", themeName);
